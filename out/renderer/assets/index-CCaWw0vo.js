...
function loadPrompt(key, fallback) {
  try {
...
const useSessionStore = create((set) => ({
  ...
  params: {
    ...defaultParams,
    setPrompt: (prompt) => {
      localStorage.setItem("anima-prompt", prompt);
      set((s) => ({ params: { ...s.params, prompt } }));
    },
    setNegativePrompt: (negativePrompt) => {
      localStorage.setItem("anima-negative-prompt", negativePrompt);
    ...
    setLora: (loraName, modelStr, clipStr) => set((s) => ({
      params: {
        ...s.params,
        loraName,
...
function HistoryPanel() {
  ...
  if (history.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-text-muted uppercase tracking-wider mb-3", children: "Histórico" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-12 text-text-muted", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { size: 32, className: "mb-2 opacity-40" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Nenhuma imagem gerada" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs mt-1", children: "Suas criações aparecerão aqui" })
      ] })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 14, className: "text-text-muted" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-text-muted uppercase tracking-wider", children: "Histórico" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-text-muted ml-auto", children: history.length })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: history.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        className: `
              ...
              ${item.id === selectedId ? "border-accent ring-1 ring-accent" : "border-transparent hover:border-border"}
            `,
        children: [
          ...
          item.params.loraName && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 px-1.5 py-1 bg-gradient-to-t from-black/80 to-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-white/80 truncate block", children: [
            "LoRA: ",
            item.params.loraName.replace(/\.(safetensors|ckpt)$/, "").slice(0, 20)
          ] }) }),
          item.id === selectedId && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 ring-1 ring-accent/30 rounded-lg pointer-events-none" })
        ]
      },
      item.id
    )) })
...
function PreviewPanel() {
  ...
  if (!selected) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center text-text-muted p-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ImageOff, { size: 48, className: "mb-3 opacity-30" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: "Selecione uma imagem" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs mt-1", children: "Clique em uma imagem no histórico para visualizar" })
    ] });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center justify-center w-full h-full p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-full max-h-full flex flex-col items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-2xl overflow-hidden shadow-2xl bg-surface-secondary group", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
      ...
      blurred && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(EyeOff, { size: 32, className: "mx-auto mb-2 text-text-muted" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-text-muted", children: "Imagem oculta por segurança" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-text-muted/60 mt-1", children: "Clique no olho para revelar" })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            blurred ? /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(EyeOff, { size: 14 }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 p-3 rounded-xl bg-surface-secondary/80 border border-border/50 text-xs w-full max-w-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-text-secondary mb-2", children: "Metadados" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-x-4 gap-y-1.5", children: loadMetadata(selected).map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-text-muted", children: m2.label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-text-primary font-mono", children: m2.value })
      ] }, m2.label)) })
    ] })
  ] }) });
}
function useGenerator() {
  ...
  const lastTriggerRef = reactExports.useRef(generateTrigger);
  const generatingRef = reactExports.useRef(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-4 overflow-y-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-medium text-text-secondary mb-1.5", children: "Prompt Positivo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            value: params.prompt,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-medium text-text-secondary mb-1.5", children: "Prompt Negativo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              modelsOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { size: 14 }),
              "Modelo de Difusão"
            ]
          }
        ),
        modelsOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: models.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-text-muted", children: "Nenhum modelo encontrado" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-48 overflow-y-auto custom-scroll", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: models.map((model) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: `
                            ...
                            transition-all
                            ${isSelected ? "border-accent ring-1 ring-accent" : "border-border hover:border-text-muted"}
                          `,
              children: [
                model.previewUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SafeImage,
                  {
                ...
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full bg-surface-tertiary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[7px] text-text-muted text-center px-1 leading-tight", children: displayName.slice(0, 18) }) }),
                isSelected && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 bottom-0 h-1 bg-accent" })
              ]
            },
            model.name
          );
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold text-text-secondary uppercase tracking-wider", children: "Parâmetros" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ParamField, { label: "Seed", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffle, { size: 14 })
              }
            )
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ParamField, { label: "Resolução", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-text-muted self-center text-xs", children: "×" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        lorasOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `
                        ...
                        transition-all
                        ${!params.loraName ? "border-accent bg-accent/10 text-accent" : "border-border bg-surface-tertiary text-text-muted hover:border-text-muted"}
                      `,
                children: "None"
              }
            ),
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `
                            ...
                            ${params.loraName === lora.name ? "border-accent ring-1 ring-accent" : "border-border hover:border-text-muted"}
                          `,
                  children: [
                    lora.previewUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      SafeImage,
                      {
                    ...
                    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full bg-surface-tertiary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] text-text-muted text-center px-1 leading-tight", children: displayName.slice(0, 15) }) }),
                    params.loraName === lora.name && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 bottom-0 h-1 bg-accent" })
                  ]
                },
                lora.name
              );
          ...
          params.loraName && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SliderField,
              {
                ...
                max: 2,
                step: 0.05,
                onChange: (v2) => params.setLora(params.loraName, v2, void 0)
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SliderField,
              {
                ...
                max: 2,
                step: 0.05,
                onChange: (v2) => params.setLora(params.loraName, void 0, v2)
              }
            )
          ] })
        ] })
      ] }),
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 rounded-lg bg-error/10 border border-error/30 text-error text-xs", children: error })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto p-4 border-t border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 text-xs text-text-muted text-center", children: "Ctrl+Enter para gerar" }),
      generating && progress && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-text-secondary", children: "Gerando..." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-text-muted font-mono", children: [
            progress.current,
            "/",
            progress.max
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-1.5 bg-surface-tertiary rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
      ...
      generating && !progress && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-text-secondary mb-3 justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 border-2 border-accent border-t-transparent rounded-full animate-spin" }),
        "Aguardando ComfyUI..."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `
            ...
            ${generating || !status.online || !params.prompt.trim() ? "bg-accent-muted text-text-muted cursor-not-allowed" : "bg-accent text-white hover:bg-accent-hover active:scale-[0.98] shadow-lg shadow-accent/20"}
          `,
...
function ParamField({ label, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs text-text-muted", children: label }) }),
    children
  ] });
}
function SliderField({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs text-text-muted", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-text-secondary font-mono", children: value })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
...
function StatusBar({ status }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `flex items-center gap-1.5 px-2 py-1 rounded-md ${isLaunching ? "bg-warning/10 text-warning" : status.online ? "bg-success/10 text-success" : "bg-error/10 text-error"}`,
      children: [
        isLaunching ? /* @__PURE__ */ jsxRuntimeExports.jsx(Loader, { size: 12, className: "animate-spin" }) : status.online ? /* @__PURE__ */ jsxRuntimeExports.jsx(Wifi, { size: 12 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(WifiOff, { size: 12 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: isLaunching ? "Iniciando ComfyUI..." : status.online ? "ComfyUI Online" : "ComfyUI Offline" })
      ]
    }
  ) });
}
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen flex flex-col bg-surface text-text-primary overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "h-12 flex items-center px-4 border-b border-border bg-surface-secondary shrink-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => {
              ...
              setHistoryOpen(next);
              localStorage.setItem("anima-history-open", String(next));
            },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-3", children: [
        ...
        loras.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-text-muted px-1.5 py-0.5 rounded bg-surface-tertiary", title: "LoRAs disponíveis", children: [
          loras.length,
          " LoRAs"
        ] }),
        models.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-text-muted px-1.5 py-0.5 rounded bg-surface-tertiary", title: "Modelos disponíveis", children: [
          models.length,
          " modelos"
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex gap-0 overflow-hidden", children: [
